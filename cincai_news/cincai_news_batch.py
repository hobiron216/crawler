    ...
    def get_items(self):
        ...
        for category in categorys:
            ...
            if category=='Malaysia':
                url = "https://www.cincainews.com/news/malaysia"
                pages=801
                self.get_url(url, category, crawl_date, pages)

            elif category=='International' :
                url = "https://www.cincainews.com/news/world"
                pages = 301
                self.get_url(url, category, crawl_date, pages)

            elif category=='Finance' :
                url = "https://www.cincainews.com/news/money"
                pages = 11
                self.get_url(url, category, crawl_date, pages)

            elif category == 'Entertainment':
                url = "https://www.cincainews.com/news/showbiz"
                pages = 31
                self.get_url(url, category, crawl_date, pages)

            elif category=='Opinion' :
                url = "https://www.cincainews.com/news/opinion"
                pages = 11
                self.get_url(url, category, crawl_date, pages)
