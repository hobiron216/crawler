...
with open("/news_cn/requests/lowyat/request_20220923/lowyat_request_20220923.json", 'r',  encoding='utf-8') as outfile:
    data_jsons = outfile.read()
...
for data_json in data_jsons:
    ...
    Path("/news_cn/requests/lowyat/request_20220923/").mkdir(parents=True, exist_ok=True)
    ...
    with open("/news_cn/requests/lowyat/request_20220923/" + nama_file + ".json", 'w', encoding='utf_8_sig') as outfile:
