...
Path("/news_cn/requests/lowyat/request/").mkdir(parents=True,exist_ok=True)
...
while a:
    i = i + 20
    print(i)
    link = "https://forum.lowyat.net/topic/5083648/+" + str(i)
    while True:
        try:
    ...
    for div in divs:
        ...
        # print(list)
        with open('/news_cn/requests/lowyat/request/lowyat.csv', 'a',  newline='', encoding='utf-8') as f_object:
