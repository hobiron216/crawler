...
loop_main_url=0
data=0
Path("/news_cn/requests/lowyat/request_20220715/detail/StockExchange/").mkdir(parents=True,exist_ok=True)
with open("/news_cn/requests/lowyat/request_20220715/index/StockExchange.json", 'r',  encoding='utf-8-sig') as outfile:
