...
class BjNews:
    ...
    def get_items(self):
        ...
        category="suara sinar"
        sub_categorys= ['lidah pengarang', 'analisis sinar', 'pojok', 'awang paku serpih', 'lain padang lain belalang']

        for sub_category in sub_categorys:
            if sub_category == 'lidah pengarang':
                url ="https://www.sinarharian.com.my/Lidah-Pengarang"
                self.get_link(category, sub_category, url, browser)
            elif sub_category == 'analisis sinar':
                url ="https://www.sinarharian.com.my/Analisis-Sinar"
                self.get_link(category, sub_category, url, browser)
            elif sub_category == 'pojok':
                url ="https://www.sinarharian.com.my/Pojok"
                self.get_link(category, sub_category, url, browser)
            elif sub_category == 'awang paku serpih':
                url ="https://www.sinarharian.com.my/Awang-Paku-Serpih"
                self.get_link(category, sub_category, url, browser)
            elif sub_category == 'lain padang lain belalang':
                url ="https://www.sinarharian.com.my/Lain-Padang-Lain-Belalang"
                self.get_link(category, sub_category, url, browser)
