...
class BjNews:
    ...
    def get_items(self):
        ...
        category="khas"
        sub_categorys= ['sinar rasuah buster', 'wacana', 'bicara minda', 'berani semuka', 'covid-19', 'wacanaquran']

        for sub_category in sub_categorys:
            if sub_category == 'sinar rasuah buster':
                url = "https://www.sinarharian.com.my/Sinar-Rasuah-Busters"
                self.get_link(category,sub_category, url, browser)
            elif sub_category == 'wacana':
                url ="https://www.sinarharian.com.my/Wacana"
                self.get_link(category, sub_category, url, browser)
            elif sub_category == 'bicara minda':
                url ="https://www.sinarharian.com.my/Bicara-Minda"
                self.get_link(category, sub_category, url, browser)
            elif sub_category == 'berani semuka':
                url ="https://www.sinarharian.com.my/Debat"
                self.get_link(category, sub_category, url, browser)
            elif sub_category == 'covid-19':
                url ="https://www.sinarharian.com.my/Covid-19"
                self.get_link(category, sub_category, url, browser)
            elif sub_category == 'wacanaquran':
                url ="https://www.sinarharian.com.my/WacanaQuran"
                self.get_link(category, sub_category, url, browser)
