...
class BjNews:
    ...
    def get_items(self):
        category="hiburan"
        sub_categorys= ['selebriti', 'gosip', 'wayang',  'lain-lain(hiburan)']

        for sub_category in sub_categorys:
            if sub_category == 'selebriti':
                url = "https://www.bharian.com.my/api/topics/8466?page="
                self.get_link(category,sub_category, url)
            elif sub_category == 'gosip':
                url ="https://www.bharian.com.my/api/topics/8467?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'wayang':
                url = "https://www.bharian.com.my/api/topics/8468?&page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'lain-lain(hiburan)':
                url = "https://www.bharian.com.my/api/topics/8469?page="
                self.get_link(category, sub_category, url)
