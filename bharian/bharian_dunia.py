...
class BjNews:
    ...
    def get_items(self):
        category="dunia"
        sub_categorys= ['asean', 'asia', 'eropah', 'amerika', 'afrika', 'lain-lain(dunia)']

        for sub_category in sub_categorys:
            if sub_category == 'asean':
                url = "https://www.bharian.com.my/api/topics/8461?page="
                self.get_link(category,sub_category, url)
            elif sub_category == 'asia':
                url ="https://www.bharian.com.my/api/topics/8460?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'eropah':
                url = "https://www.bharian.com.my/api/topics/8462?&page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'amerika':
                url = "https://www.bharian.com.my/api/topics/8463?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'afrika':
                url = "https://www.bharian.com.my/api/topics/8464?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'lain-lain(dunia)':
                url = "https://www.bharian.com.my/api/topics/8465?page="
                self.get_link(category, sub_category, url)
