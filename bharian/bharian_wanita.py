...
class BjNews:
    ...
    def __init__(self):
        ...
        self.list_link = []
        self.path = "/home/news/bharian2/"
        self.site_name = "bharian"

    def get_items(self):
        category="wanita"
        sub_categorys= ['keluarga', 'rias', 'fesyen', 'lain-lain(wanita)']

        for sub_category in sub_categorys:
            if sub_category == 'keluarga':
                url = "https://www.bharian.com.my/api/topics/8479?page="
                self.get_link(category,sub_category, url)
            elif sub_category == 'rias':
                url ="https://www.bharian.com.my/api/topics/8480?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'fesyen':
                url = "https://www.bharian.com.my/api/topics/8481?&page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'lain-lain(wanita)':
                url = "https://www.bharian.com.my/api/topics/8482?page="
                self.get_link(category, sub_category, url)
