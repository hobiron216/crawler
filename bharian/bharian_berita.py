...
class BjNews:
    ...
    def get_items(self):
        category="berita"
        sub_categorys= ['nasional', 'kes', 'politik', 'pendidikan', 'wilayah']

        for sub_category in sub_categorys:
            if sub_category == 'nasional':
                url = "https://www.bharian.com.my/api/topics/1?page="
                self.get_link(category,sub_category, url)
            elif sub_category == 'kes':
                url ="https://www.bharian.com.my/api/topics/8453?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'politik':
                url = "https://www.bharian.com.my/api/topics/132?&page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'pendidikan':
                url = "https://www.bharian.com.my/api/topics/8454?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'wilayah':
                url = "https://www.bharian.com.my/api/topics/8455?page="
                self.get_link(category, sub_category, url)
