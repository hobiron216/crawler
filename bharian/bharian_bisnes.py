...
class BjNews:
    ...
    def get_items(self):
        category="bisnes"
        sub_categorys= ['pasaran', 'korporat', 'auto', 'hartanah', 'teknologi', 'usahawan', 'lain-lain(bisnes)']

        for sub_category in sub_categorys:
            if sub_category == 'pasaran':
                url = "https://www.bharian.com.my/api/topics/8470?page="
                self.get_link(category,sub_category, url)
            elif sub_category == 'korporat':
                url ="https://www.bharian.com.my/api/topics/8471?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'auto':
                url = "https://www.bharian.com.my/api/topics/4444?&page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'hartanah':
                url = "https://www.bharian.com.my/api/topics/4967?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'teknologi':
                url = "https://www.bharian.com.my/api/topics/8473?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'usahawan':
                url = "https://www.bharian.com.my/api/topics/8474?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'lain-lain(bisnes)':
                url = "https://www.bharian.com.my/api/topics/8475?page="
                self.get_link(category, sub_category, url)
    ...
    def get_link(self, category, sub_category, url21):
        ...
        for page in range (0,100) :
            ...
            for data_json in r:
                ...
                content21 = content.split(":")
                try :
                    content=content21[1].strip()
                    location21 = content21[0].split("my")
                    location = location21[1].strip()
                except :
                    continue
                try:
