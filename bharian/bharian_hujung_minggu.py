...
class BjNews:
    ...
    def get_items(self):
        category="hujung minggu"
        sub_categorys= ['sihat', 'santai', 'kembara', 'selera', 'lain-lain(hujung minggu)']

        for sub_category in sub_categorys:
            if sub_category == 'sihat':
                url = "https://www.bharian.com.my/api/topics/88211?page="
                self.get_link(category,sub_category, url)
            elif sub_category == 'santai':
                url ="https://www.bharian.com.my/api/topics/8483?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'kembara':
                url = "https://www.bharian.com.my/api/topics/8484?&page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'selera':
                url = "https://www.bharian.com.my/api/topics/8485?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'lain-lain(hujung minggu)':
                url = "https://www.bharian.com.my/api/topics/8486?page="
                self.get_link(category, sub_category, url)
    ...
    def get_link(self, category, sub_category, url21):
        ...
        for page in range (0,100) :
            if z>0:
                break
            print(page)
            link21 = url21 + str(page) + "&page_size=20"
