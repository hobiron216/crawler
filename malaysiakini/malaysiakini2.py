...
class BjNews:
    ...
    def get_items(self):
        categorys=['ulasan', 'surat', 'lensa kini', 'jejak covid-19', 'laporan khas', 'wawancara', 'pengumuman']
        for category in categorys:
            if category == 'ulasan' :
                url = "https://m.malaysiakini.com/api/my/tag/ulasan/"
                tag = "news/"
                self.get_link(category, url, tag)
            elif category == 'surat' :
                url = "https://m.malaysiakini.com/api/my/latest/letters/"
                tag = "letters/"
                self.get_link(category, url, tag)
            elif category == 'lensa kini' :
                url = "https://m.malaysiakini.com/api/my/latest/photos/"
                tag = "photos/"
                self.get_link(category, url, tag)
            elif category == 'jejak covid-19' :
                url = "https://www.malaysiakini.com/api/my/tag/covid-19/"
                tag = "news/"
                self.get_link(category, url, tag)
            elif category == 'laporan khas' :
                url = "https://m.malaysiakini.com/api/my/tag/laporan%20khas/"
                tag = "news/"
                self.get_link(category, url, tag)
            elif category == 'wawancara' :
                url = "https://m.malaysiakini.com/api/my/tag/wawancara/"
                tag = "news/"
                self.get_link(category, url, tag)
            # elif category == 'pengumuman' :
            #     url = "https://m.malaysiakini.com/api/my/announcement?page=0"
            #     tag = "announcement/"
            #     self.get_link(category, url, tag)
