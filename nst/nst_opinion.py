...
class BjNews:
    ...
    def get_items(self):
        category="opinion"
        sub_categorys= ['leader', 'letters', 'columnists']

        for sub_category in sub_categorys:
            if sub_category == 'leader':
                url = "https://www.nst.com.my/api/topics/22839?page="
                self.get_link(category,sub_category, url)
            elif sub_category == 'letters':
                url ="https://www.nst.com.my/api/topics/9?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'columnists':
                url = "https://www.nst.com.my/api/topics/7?page="
                self.get_link(category, sub_category, url)
