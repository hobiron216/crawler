...
class BjNews:
    ...
    def get_items(self):
        category="sports"
        sub_categorys= ['football', 'badminton', 'tennis', 'cycling', 'golf', 'mma', 'motor sports', 'cricket', 'others']

        for sub_category in sub_categorys:
            if sub_category == 'football':
                url = "https://www.nst.com.my/api/topics/57?page="
                self.get_link(category,sub_category, url)
            elif sub_category == 'badminton':
                url ="https://www.nst.com.my/api/topics/49?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'tennis':
                url = "https://www.nst.com.my/api/topics/22837?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'cycling':
                url = "https://www.nst.com.my/api/topics/46?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'golf':
                url = "https://www.nst.com.my/api/topics/22838?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'mma':
                url = "https://www.nst.com.my/api/topics/22836?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'motor sports':
                url = "https://www.nst.com.my/api/topics/59?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'cricket':
                url = "https://www.nst.com.my/api/topics/66?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'others':
                url = "https://www.nst.com.my/api/topics/22941?page="
                self.get_link(category, sub_category, url)
