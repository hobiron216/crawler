...
class BjNews:
    ...
    def get_items(self):
        category="news"
        sub_categorys= ['exclusive', 'crime & courts', 'nation', 'goverment, public policy', 'politic']

        for sub_category in sub_categorys:
            if sub_category == 'exclusive':
                url = "https://www.nst.com.my/api/topics/60?page="
                self.get_link(category,sub_category, url)
            elif sub_category == 'crime & courts':
                url ="https://www.nst.com.my/api/topics/22826?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'nation':
                url = "https://www.nst.com.my/api/topics/1?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'goverment, public policy':
                url = "https://www.nst.com.my/api/topics/22827?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'politic':
                url = "https://www.nst.com.my/api/topics/76?page="
                self.get_link(category, sub_category, url)
