...
class BjNews:
    ...
    def get_items(self):
        category="life & times"
        sub_categorys= ['bots', 'heal', 'flair', 'jomi', 'groove', 'sunday vibes']

        for sub_category in sub_categorys:
            if sub_category == 'bots':
                url = "https://www.nst.com.my/api/topics/22828?page="
                self.get_link(category,sub_category, url)
            elif sub_category == 'heal':
                url ="https://www.nst.com.my/api/topics/53?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'flair':
                url = "https://www.nst.com.my/api/topics/22942?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'jomi':
                url = "https://www.nst.com.my/api/topics/50?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'groove':
                url = "https://www.nst.com.my/api/topics/22831?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'sunday vibes':
                url = "https://www.nst.com.my/api/topics/22834?page="
                self.get_link(category, sub_category, url)
