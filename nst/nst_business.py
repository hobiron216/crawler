...
class BjNews:
    ...
    def get_items(self):
        category="business"
        sub_categorys= ['business times', 'property', 'cars bikes trucks']

        for sub_category in sub_categorys:
            if sub_category == 'business times':
                url = "https://www.nst.com.my/api/topics/3?page="
                self.get_link(category,sub_category, url)
            elif sub_category == 'property':
                url ="https://www.nst.com.my/api/topics/417?page="
                self.get_link(category, sub_category, url)
            elif sub_category == 'cars bikes trucks':
                url = "https://www.nst.com.my/api/topics/16265?page="
                self.get_link(category, sub_category, url)
