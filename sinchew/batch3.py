...
class Sinchew:
    ...
    def create_folder(self,crawl_date):
        ...
        Path("/dataph/requests/news/sinchew/batch/html/"+crawl_date+ "/category/" ).mkdir(parents=True, exist_ok=True)
        Path("/dataph/requests/news/sinchew/batch/json/"+crawl_date+ "/category/" ).mkdir(parents=True, exist_ok=True)
    ...
    def get_parser(self, crawl_date,a,i):#,browser):
            ...
            while v :
                ...
                # print(obj)/home/shahid/Documents/TugasmasEliaEM/cina2/dataph
                    ...
                    with open("/dataph/requests/news/sinchew/batch/html/"+crawl_date+ "/category/" + href21 + ".html", 'w') as outfile:
                        outfile.write(str(soup))
                    with open("/dataph/requests/news/sinchew/batch/json/"+crawl_date+ "/category/" + href21 + ".json", 'w') as outfile:
