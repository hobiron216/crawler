...
while status_code == 200 and page <= 15:
	...
	#---------save index html------------#
	filename_index = "/home/amel/orientaldaily/html/index/{}/entertainment/index_{}.html".format(today,hash(link))
...
# print(title_link)
	...
	#---------parsing url, title, date, article to json--------#
		...
		#---------save detail html------------#
			filename_content = "/home/amel/orientaldaily/html/content/{}/entertainment/detail_{}.html".format(today,hash(detail_url))
	...
	#-----------save detail json-------------#
			filename_json = "/home/amel/orientaldaily/json/content/{}/entertainment/detail_{}.json".format(today,hash(detail_url))
