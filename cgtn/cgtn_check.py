...
class Kwong:
    ...
    def create_folder(self, crawl_date, category, sub_category):
        Path(self.path +"/html/" + crawl_date + "/" + self.current_time + "/" + category + "/" + sub_category + "/").mkdir(parents=True,exist_ok=True)
        Path(self.path +"/json/" + crawl_date + "/" + self.current_time + "/" + category + "/" + sub_category + "/").mkdir(parents=True,exist_ok=True)
        ...
        for url in self.list_link:
            if url not in self.list_url:
                ...
                try :
                    ...
                    path_html = self.path+"/html/" + crawl_date + "/" + self.current_time + "/" + category + "/" + sub_category + "/" +   href21 + ".html"
                    ...
                    # break
                    self.a = self.a + 1
                    with open(self.path+"/html/" + crawl_date + "/" + self.current_time + "/" + category +  "/" + sub_category + "/" +  href21 + ".html",'w',encoding='utf8') as outfile:
                        outfile.write(str(soup))
                    with open(self.path+"/json/" + crawl_date + "/" + self.current_time + "/" + category + "/" + sub_category + "/" +  href21 + ".json",'w',encoding='utf_8_sig') as outfile:
