...
with open("/home/amel/thepeopledaily/check_first_url_society-5.json", 'r', encoding='utf_8_sig') as outfile:
  first_url= json.load(outfile)
list_url = []

data=0
url = "http://society.people.com.cn/GB/229589/index" #society-5
page = 0
max_page = 6
# print(proxy_)
...
while page < max_page :
	...
	headers = {'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
		...
		'Host': 'society.people.com.cn',
		'Referer': 'http://society.people.com.cn/GB/229589/index.html',
	...
	try :
		...
		filename_index = "/home/amel/thepeopledaily/daily/html/index/{}/{}/society/society-5/index_{}.html".format(today,hours,hash(link))
		...
		title_link = []
		for index in soup.select('.p1_left.fl>div>h2>a'): #selector detail link in index page
		...
		while link_index_array <= title_link_count :
			...
			head_url = "http://society.people.com.cn/"
			...
			try : 
				...
				if response_detail.status_code == 403 :
					json_data = {'url':str(detail_link), 'article':"403 FORBIDDEN"}
					# print(json_data)
				...
				filename_content = "/home/amel/thepeopledaily/daily/html/content/{}/{}/society/society-5/detail_{}.html".format(today,hours,hash(detail_url))
				...
				filename_json = "/home/amel/thepeopledaily/daily/json/content/{}/{}/society/society-5/detail_{}.json".format(today,hours,hash(detail_url))
				...
				except_json = {'link':detail_link,'date':today,'category':'society-5'}
				filename_except = "/home/amel/thepeopledaily/daily/except/content/{}/{}/society/society-5/detail_except.json".format(today,hours)
...
with codecs.open("/home/amel/thepeopledaily/check_first_url_society-5.json", 'w',encoding="utf_8_sig") as l:
