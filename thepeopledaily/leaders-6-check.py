...
with open("/home/amel/thepeopledaily/check_first_url_leaders-6.json", 'r', encoding='utf_8_sig') as outfile:
  first_url= json.load(outfile)
list_url = []

data=0
url = "http://leaders.people.com.cn/GB/372900/index" #leaders-6
page = 0
max_page = 6
# print(proxy_)
...
while page < max_page :
	...
	headers = {'Referer': 'http://leaders.people.com.cn/GB/372900/index4.html',
	...
	try :
		...
		filename_index = "/home/amel/thepeopledaily/daily/html/index/{}/{}/leaders/leaders-6/index_{}.html".format(today,hours,hash(link))
		...
		title_link = []
		for index in soup.select('.hdNews.clearfix>p>strong>a'): #selector detail link in index page
		...
		while link_index_array <= title_link_count :
			...
			try : 
				...
				if len(detail_article) == 0 :
					...
					detail_article = sp_detail.select('#rwb_zw>p')
					if len(detail_article) == 0 :
				...
				filename_content = "/home/amel/thepeopledaily/daily/html/content/{}/{}/leaders/leaders-6/detail_{}.html".format(today,hours,hash(detail_url))
				...
				filename_json = "/home/amel/thepeopledaily/daily/json/content/{}/{}/leaders/leaders-6/detail_{}.json".format(today,hours,hash(detail_url))
				...
				except_json = {'link':detail_link,'date':today,'category':'leaders-6'}
				filename_except = "/home/amel/thepeopledaily/daily/except/content/{}/{}/leaders/leaders-6/detail_except.json".format(today,hours)
...
with codecs.open("/home/amel/thepeopledaily/check_first_url_leaders-6.json", 'w',encoding="utf_8_sig") as l:
