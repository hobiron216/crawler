...
with open("/home/amel/thepeopledaily/check_first_url_military-8.json", 'r', encoding='utf_8_sig') as outfile:
  first_url= json.load(outfile)
list_url = []

data=0
url = "http://military.people.com.cn/GB/43331/index" #military-8
page = 0
max_page = 6
# print(proxy_)
...
while page < max_page :
	...
	headers = {'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
		...
		'Referer': 'http://military.people.com.cn/GB/43331/index.html',
	...
	try :
		...
		filename_index = "/home/amel/thepeopledaily/daily/html/index/{}/{}/military/military-8/index_{}.html".format(today,hours,hash(link))
		...
		title_link = []
		for index in soup.select('.ej_img_box.clear.clearfix>div>a'): #selector detail link in index page
		...
		while link_index_array <= title_link_count :
			...
			try : 
				...
				filename_content = "/home/amel/thepeopledaily/daily/html/content/{}/{}/military/military-8/detail_{}.html".format(today,hours,hash(detail_url))
				...
				filename_json = "/home/amel/thepeopledaily/daily/json/content/{}/{}/military/military-8/detail_{}.json".format(today,hours,hash(detail_url))
				...
				except_json = {'link':detail_link,'date':today,'category':'military-8'}
				filename_except = "/home/amel/thepeopledaily/daily/except/content/{}/{}/military/military-8/detail_except.json".format(today,hours)
...
with codecs.open("/home/amel/thepeopledaily/check_first_url_military-8-.json", 'w',encoding="utf_8_sig") as l:
