...
with open("/home/amel/thepeopledaily/check_first_url_politics-6.json", 'r', encoding='utf_8_sig') as outfile:
...
while page < max_page :
	...
	try :
		...
		filename_index = "/home/amel/thepeopledaily/daily/html/index/{}/{}/politics/politics-6/index_{}.html".format(today,hours,hash(link))
		...
		while link_index_array <= title_link_count :
			...
			# try : 
				...
				try : 
					...
					filename_content = "/home/amel/thepeopledaily/daily/html/content/{}/{}/politics/politics-6/detail_{}.html".format(today,hours,hash(detail_url))
					...
					filename_json = "/home/amel/thepeopledaily/daily/json/content/{}/{}/politics/politics-6/detail_{}.json".format(today,hours,hash(detail_url))
					...
					filename_except = "/home/amel/thepeopledaily/daily/except/content/{}/{}/politics/politics-6/detail_except.json".format(today,hours)
