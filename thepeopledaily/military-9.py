...
while page < max_page :
	...
	try :
		...
		filename_index = "/home/amel/thepeopledaily/daily/html/index/{}/military/military-9/index_{}.html".format(today,hash(link))
		...
		while link_index_array <= title_link_count :
			...
			try : 
				...
				try : 
					...
					filename_content = "/home/amel/thepeopledaily/daily/html/content/{}/military/military-9/detail_{}.html".format(today,hash(detail_url))
					...
					filename_json = "/home/amel/thepeopledaily/daily/json/content/{}/military/military-9/detail_{}.json".format(today,hash(detail_url))
					...
					filename_except = "/home/amel/thepeopledaily/daily/except/content/{}/military/military-9/detail_except.json".format(today)
