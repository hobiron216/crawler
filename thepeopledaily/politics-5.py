...
while page < max_page :
	...
	try :
		...
		filename_index = "/home/amel/thepeopledaily/daily/html/index/{}/politics/politics-5/index_{}.html".format(today,hash(link))
		...
		while link_index_array <= title_link_count :
			...
			try : 
				...
				try : 
					...
					filename_content = "/home/amel/thepeopledaily/daily/html/content/{}/politics/politics-5/detail_{}.html".format(today,hash(detail_url))
					...
					filename_json = "/home/amel/thepeopledaily/daily/json/content/{}/politics/politics-5/detail_{}.json".format(today,hash(detail_url))
					...
					filename_except = "/home/amel/thepeopledaily/daily/except/content/{}/politics/politics-5/detail_except.json".format(today)
