...
with open("/home/amel/thepeopledaily/check_first_url_military-2.json", 'r', encoding='utf_8_sig') as outfile:
  first_url= json.load(outfile)
list_url = []

data=0
url = "http://military.people.com.cn/GB/52963/index" #military-2
page = 0
max_page = 6
# print(proxy_)
...
while page < max_page :
	...
	try :
		...
		filename_index = "/home/amel/thepeopledaily/daily/html/index/{}/{}/military/military-2/index_{}.html".format(today,hours,hash(link))
		...
		title_link = []
		for index in soup.select('.ej_list_box.clear>ul>li>a'): #selector detail link in index page
		...
		while link_index_array <= title_link_count :
			...
			head_url = "http://military.people.com.cn/"
			...
			try : 
				...
				# print(detail_title)
				# detail_title = str(detail_title).encode("utf_8_sig")
				# detail_title = detail_title.decode('utf-8')
				# detail_title = sp_detail.select('.clearfix.w1000_320.text_title >h1')
				...
				filename_content = "/home/amel/thepeopledaily/daily/html/content/{}/{}/military/military-2/detail_{}.html".format(today,hours,hash(detail_url))
				...
				filename_json = "/home/amel/thepeopledaily/daily/json/content/{}/{}/military/military-2/detail_{}.json".format(today,hours,hash(detail_url))
				...
				except_json = {'link':detail_link,'date':today,'category':'military-2'}
				filename_except = "/home/amel/thepeopledaily/daily/except/content/{}/{}/military/military-2/detail_except.json".format(today,hours)
...
with codecs.open("/home/amel/thepeopledaily/check_first_url_military-2.json", 'w',encoding="utf_8_sig") as l:
