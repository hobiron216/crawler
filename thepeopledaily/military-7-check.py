...
with open("/home/amel/thepeopledaily/check_first_url_military-7.json", 'r', encoding='utf_8_sig') as outfile:
  first_url= json.load(outfile)
list_url = []

data=0
url = "http://military.people.com.cn/GB/42969/index" #military-7
page = 0
max_page = 6
# print(proxy_)
...
while page < max_page :
	...
	try :
		...
		filename_index = "/home/amel/thepeopledaily/daily/html/index/{}/{}/military/military-7/index_{}.html".format(today,hours,hash(link))
		...
		while link_index_array <= title_link_count :
			...
			try : 
				...
				filename_content = "/home/amel/thepeopledaily/daily/html/content/{}/{}/military/military-7/detail_{}.html".format(today,hours,hash(detail_url))
				...
				filename_json = "/home/amel/thepeopledaily/daily/json/content/{}/{}/military/military-7/detail_{}.json".format(today,hours,hash(detail_url))
				...
				except_json = {'link':detail_link,'date':today,'category':'military-7'}
				filename_except = "/home/amel/thepeopledaily/daily/except/content/{}/{}/military/military-7/detail_except.json".format(today,hours)
...
with codecs.open("/home/amel/thepeopledaily/check_first_url_military-7.json", 'w',encoding="utf_8_sig") as l:
