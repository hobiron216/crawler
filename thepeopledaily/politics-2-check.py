...
with open("/home/amel/thepeopledaily/check_first_url_politics-2.json", 'r', encoding='utf_8_sig') as outfile:
  first_url= json.load(outfile)
list_url = []

data=0
url = "http://politics.people.com.cn/GB/1027/index" #politics-2
page = 0
max_page = 6
# print(proxy_)
...
while page < max_page :
	...
	headers = {'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
		...
		'Referer': 'http://politics.people.com.cn/GB/1027/index2.html',
	...
	try :
		...
		filename_index = "/home/amel/thepeopledaily/daily/html/index/{}/{}/politics/politics-2/index_{}.html".format(today,hours,hash(link))
		...
		while link_index_array <= title_link_count :
			...
			try : 
				...
				filename_content = "/home/amel/thepeopledaily/daily/html/content/{}/{}/politics/politics-2/detail_{}.html".format(today,hours,hash(detail_url))
				...
				filename_json = "/home/amel/thepeopledaily/daily/json/content/{}/{}/politics/politics-2/detail_{}.json".format(today,hours,hash(detail_url))
				...
				except_json = {'link':detail_link,'date':today,'category':'politics-2'}
				filename_except = "/home/amel/thepeopledaily/daily/except/content/{}/{}/politics/politics-2/detail_except.json".format(today,hours)
...
with codecs.open("/home/amel/thepeopledaily/check_first_url_politics-2.json", 'w',encoding="utf_8_sig") as l:
