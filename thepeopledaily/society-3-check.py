...
url = "http://society.people.com.cn/GB/1062/index" #society-3
page = 0
max_page = 6
# print(proxy_)
...
with open("/home/amel/thepeopledaily/check_first_url_society-3.json", 'r', encoding='utf_8_sig') as outfile:
...
while page < max_page :
	...
	headers = {'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
		...
		'Referer': 'http://society.people.com.cn/GB/1062/index.html',
	...
	try :
		...
		filename_index = "/home/amel/thepeopledaily/daily/html/index/{}/{}/society/society-3/index_{}.html".format(today,hours,hash(link))
		...
		while link_index_array <= title_link_count :
			...
			try : 
				...
				filename_content = "/home/amel/thepeopledaily/daily/html/content/{}/{}/society/society-3/detail_{}.html".format(today,hours,hash(detail_url))
				...
				filename_json = "/home/amel/thepeopledaily/daily/json/content/{}/{}/society/society-3/detail_{}.json".format(today,hours,hash(detail_url))
				...
				except_json = {'link':detail_link,'date':today,'category':'society-3'}
				filename_except = "/home/amel/thepeopledaily/daily/except/content/{}/{}/society/society-3/detail_except.json".format(today,hours)
...
with codecs.open("/home/amel/thepeopledaily/check_first_url_society-3.json", 'w',encoding="utf_8_sig") as l:
