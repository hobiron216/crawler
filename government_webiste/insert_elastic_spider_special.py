...
for index, df2 in df.iterrows():
    ...
    # if not base_url:
    #     continue
    if base_url != "http://www.mybsn.com.my/":
        continue
    if base_url == "http://www.mybsn.com.my/":
        base_url = "https://www.bsn.com.my/"
    ...
    for root, dirs, files in os.walk("/dataph/government4/" + sitename + "/"):
        for file in files:
            ...
            raw_html = root.replace("goverment4", "government") + file
