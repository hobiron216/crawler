...
class Spider:
    ...
    def __init__(self):
        self.base_link = "https://www.businesslist.my/"
        self.website = "businesslist"
        self.a = 0
        ...
        for div in divs:
            try :
                ...
                if "https:" in href or "http:" in href:
                    ...
                    href = "https://www.businesslist.my" + href
    ...
    def url_detail(self):
        ...
        for url in self.list_link:
            if url =="https://www.businesslist.my/":
                continue
            ...
            category = url.replace("https://www.businesslist.my/","").replace(nama_file,"")
