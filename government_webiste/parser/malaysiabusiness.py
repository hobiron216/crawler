...
class Spider:
    ...
    def __init__(self):
        self.base_link = "https://www.mysbusiness.com/"
        self.website = "malaysiabusiness"
        self.a = 0
    ...
    def get_url (self, url):
        ...
        for div in divs:
            ...
            if "JPG" in href or "PNG" in href:
                continue
            if "https://www.mysbusiness.com/" in href:
    ...
    def url_detail(self):
        ...
        for url in self.list_link:
            if url =="https://www.mysbusiness.com/":
                continue
            ...
            category = url.replace("https://www.mysbusiness.com/","").replace(nama_file,"")
