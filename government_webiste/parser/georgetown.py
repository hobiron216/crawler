...
class Spider:
    ...
    def __init__(self):
        self.base_link = "https://georgetown.my.yalwa.asia/"
        self.website = "georgetown"
        self.a = 0
    ...
    def get_url (self, url):
        ...
        for div in divs:
            ...
            if "JPG" in href or "PNG" in href:
                continue
            if "https://georgetown.my.yalwa.asia/" in href:
    ...
    def url_detail(self):
        ...
        for url in self.list_link:
            if url =="https://georgetown.my.yalwa.asia/":
                continue
            ...
            category = url.replace("https://georgetown.my.yalwa.asia/","").replace(nama_file,"")
