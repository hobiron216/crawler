...
class Spider:
    ...
    def __init__(self):
        self.base_link = "https://contactmenumber.com/my/data/accouting_contact.php#"
        self.website = "contactnumber"
        self.a = 0
        ...
        for div in divs:
            try :
                ...
                if "https:" in href or "http:" in href :
                    ...
                    blank = div.attrs.get('target')
                    if blank == "_blank":
                        href = "https://contactmenumber.com/my/data/" + href
                    else:
                        href = "https://contactmenumber.com/my/" + href
    ...
    def url_detail(self):
        ...
        for url in self.list_link:
            if url =="https://contactmenumber.com/my/":
                continue
            ...
            category = url.replace("https://contactmenumber.com/", "").replace(nama_file, "")
