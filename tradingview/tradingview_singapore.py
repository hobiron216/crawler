...
class Merits:
    ...
    def __init__(self):
        ...
        self.website = "tradingview_singapore"
        self.a = 0
    ...
    def get_items(self):
        ...
        for main_category in main_categorys:
            if main_category == "sector":
                url = self.base_link + "/markets/stocks-singapore/sectorandindustry-sector/"
                ...
                url = self.base_link + "/markets/stocks-singapore/sectorandindustry-industry/"
                self.get_category(url)
                self.parser(self.list_link, crawl_date, main_category)
                self.list_link.clear()
                del self.list_link[:]
