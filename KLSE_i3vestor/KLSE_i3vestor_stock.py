...
Path("/home/KLSE_i3vestor2/stock/").mkdir(parents=True,exist_ok=True)
    ...
    for div in divs:
        ...
        while True:
            ...
            if j==1:
                ...
                try :
                    try :
                        last_price = soup2.find("td", class_="up big16").get_text()
                    except:
                        last_price = soup2.find("td", class_="down big16").get_text()
                    try :
                        todays_change = soup2.find("span", class_="down").get_text()
                    except:
                        todays_change = soup2.find("span", class_="up").get_text()


                    days_range = soup2.find("td", class_="big16").get_text()
                    trading_volume = soup2.find("td", class_="big16 right").get_text()
                except:
                    last_price = ""
                    todays_change = ""
                    days_range=""
                ...
                result = {
                    ...
                    "todays_change" : str(todays_change),
                    "days_range" : str(days_range),
