...
class BjNews:
    ...
    def __init__(self):
        ...
        self.list_link = []
        self.path = "/home/news/utusan/"
        self.site_name = "utusan"


    def get_items(self):

        categorys= ['terkini', 'nasional', 'ekonomi', 'luar_negara', 'gaya', 'sukan', 'rencana']

        for category in categorys:
            self.z=0
            if category == 'terkini':
                continue
                url = "https://www.utusan.com.my/a/" + category
                self.get_link(category, url)
            elif category == 'nasional':
                continue
                url = "https://www.utusan.com.my/a/" + category
                self.get_link(category, url)
    ...
    def get_link(self, category,url21):
        for page in range (0,1000) :
            ...
            divs = soup.findAll("a", class_="elementor-post__thumbnail__link")
            for div in divs:
                # print("wkwkw")
        ...
        for url in list_link:
            ...
            try :
                ...
                if bulan == 3 or bulan == 4 or bulan == 5:
                    ...
                    ndate = ndate[0]
                    ndate = ndate.replace("-", "")
                    contents = soup.find("div", class_="dable-content-wrapper").findAll("p")
                    content22 = ""
