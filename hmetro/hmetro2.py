...
class BjNews:
    ...
    def get_items(self):
        categorys= ['akademia', 'itmetro', 'nuansa', 'santai', 'pnp', 'dekotaman', 'WM', 'rencana', 'sihat', 'xpresi', 'vroom' ]
        for category in categorys:
            if category == 'akademia':
                url = "https://www.hmetro.com.my/"+ category + "?page="
                self.get_url(category,url)
            elif category == 'itmetro' :
                url = "https://www.hmetro.com.my/" + category + "?page="
                self.get_url(category, url)
            elif category == "nuansa" :
                url = "https://www.hmetro.com.my/" + category + "?page="
                self.get_url(category, url)
            elif category == 'santai' :
                url = "https://www.hmetro.com.my/" + category + "?page="
                self.get_url(category, url)
            elif category == "pnp" :
                url = "https://www.hmetro.com.my/" + category + "?page="
                self.get_url(category, url)
            elif category == 'dekotaman' :
                url = "https://www.hmetro.com.my/" + category + "?page="
                self.get_url(category, url)
            elif category == "WM" :
                url = "https://www.hmetro.com.my/" + category + "?page="
