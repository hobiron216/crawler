...
class BjNews:
    ...
    def get_items(self):
        ...
        category = 'arena'
        sub_categorys = ['badminton', 'bola-sepak', 'esukan', 'hoki', 'permotoran', 'sukan', 'lain']
        for sub_category in sub_categorys:
            self.z = 0
            if sub_category == 'badminton':
                continue
                url = "https://www.hmetro.com.my/"+ category + "/" + sub_category + "?page="
                self.get_url(category,url, browser, sub_category)
            elif sub_category == 'bola-sepak':
                # continue
                url = "https://www.hmetro.com.my/"+ category + "/" + sub_category + "?page="
                self.get_url(category,url, browser, sub_category)
            elif sub_category == 'esukan':
                # continue
                url = "https://www.hmetro.com.my/"+ category + "/" + sub_category + "?page="
                self.get_url(category,url, browser, sub_category)
            elif sub_category == 'hoki':
                # continue
                url = "https://www.hmetro.com.my/"+ category + "/" + sub_category + "?page="
                self.get_url(category,url, browser, sub_category)
            elif sub_category == 'permotoran':
                # continue
                url = "https://www.hmetro.com.my/"+ category + "/" + sub_category + "?page="
                self.get_url(category,url, browser, sub_category)
    ...
    def get_url(self, category, url, browser, sub_category) :
        z=0
        for i in range(0, 21):
            if self.z>0:
                break
            ...
            self.parser(self.list_link, crawl_date, category, i, browser, sub_category)
            del self.list_link[:]

        
    def parser(self,list_link, crawl_date, category, page, browser, sub_category):
        z=0
