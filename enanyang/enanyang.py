...
class Sinchew:
    ...
    def __init__(self):
        ...
        self.path="/news_cn/requests/news/enanyang/"
        self.link_fail=[]
        self.test=1
        self.list_link2 = []
    ...
    def get_items(self):
        ...
        categorys = ['economic','global_anti-epidemic', 'international', 'news']
        print ("====================================================" + crawl_date + "============================================================")
        for category in categorys :
            if category == 'economic':
                url = "https://www.enanyang.my/api/get/term/articles/10?page="
                self.get_html(category, url, crawl_date)
            elif category == 'global_anti-epidemic':
                url = "https://www.enanyang.my/api/get/term/articles/3216?page="
                self.get_html(category, url, crawl_date)
            elif category == 'international':
                url = "https://www.enanyang.my/api/get/term/articles/11?page="
                self.get_html(category, url, crawl_date)
            elif category == 'news':
                url = "https://www.enanyang.my/api/get/term/articles/12?page="
                self.get_html(category, url, crawl_date)
