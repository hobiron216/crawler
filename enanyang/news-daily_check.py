...
with open("/home/amel/enanyang/check_first_url_news.json", 'r', encoding='utf_8_sig') as outfile:
...
# 	# print(link)
	...
	#---------save index html------------#
	filename_index = "/home/amel/enanyang/json/index/{}/{}/news/index_{}.json".format(date,hours,hash(link))
	...
	for j in jsonStr :
		...
		##-------save detail html-------##
		filename_content = "/home/amel/enanyang/html/content/{}/{}/news/detail_{}.html".format(date,hours,hash(detail_url))
		...
		##-----------save detail json-------------##
		filename_json = "/home/amel/enanyang/json/content/{}/{}/news/detail_{}.json".format(date,hours,hash(detail_url))
