...
with open("/home/amel/enanyang/check_first_url_economic.json", 'r', encoding='utf_8_sig') as outfile:
  first_url= json.load(outfile)
list_url = []

data=0
url = "https://www.enanyang.my/api/get/term/articles/10?page=" ##economic=10
page1 = str(url)+str(1)
...
# 	# print(link)
	...
	#---------save index html------------#
	filename_index = "/home/amel/enanyang/json/index/{}/{}/economic/index_{}.json".format(date,hours,hash(link))
	...
	for j in jsonStr :
		...
		##-------save detail html-------##
		filename_content = "/home/amel/enanyang/html/content/{}/{}/economic/detail_{}.html".format(date,hours,hash(detail_url))
		...
		##-----------save detail json-------------##
		filename_json = "/home/amel/enanyang/json/content/{}/{}/economic/detail_{}.json".format(date,hours,hash(detail_url))
