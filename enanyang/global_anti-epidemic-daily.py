...
# 	# print(link)
	...
	#---------save index html------------#
	filename_index = "/home/amel/enanyang/json/index/{}/global_anti-epidemic/index_{}.json".format(date,hash(link))
	...
	for j in jsonStr :
		try :
			...
			##-------save detail html-------##
			filename_content = "/home/amel/enanyang/html/content/{}/global_anti-epidemic/detail_{}.html".format(date,hash(detail_url))
			...
			##-----------save detail json-------------##
			filename_json = "/home/amel/enanyang/json/content/{}/global_anti-epidemic/detail_{}.json".format(date,hash(detail_url))
