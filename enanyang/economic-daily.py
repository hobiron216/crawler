...
data=0
url = "https://www.enanyang.my/api/get/term/articles/10?page=" ##economic=11
page1 = str(url)+str(1)
...
# 	# print(link)
	...
	#---------save index html------------#
	filename_index = "/home/amel/enanyang/json/index/{}/economic/index_{}.json".format(date,hash(link))
	...
	for j in jsonStr :
		try :
			...
			##-------save detail html-------##
			filename_content = "/home/amel/enanyang/html/content/{}/economic/detail_{}.html".format(date,hash(detail_url))
			...
			##-----------save detail json-------------##
			filename_json = "/home/amel/enanyang/json/content/{}/economic/detail_{}.json".format(date,hash(detail_url))
			...
			print("skip : " + tl)
	page=page+1
print("first url : "+list_url[0])
message = "Engine : Enanyang  \n" + "Category : economic \n" +  "Data : " + str(data)
telegram_bot_sendtext(str(message))

# with codecs.open("/home/amel/enanyang/check_url_economic_daily.json", 'w',encoding="utf_8_sig") as l:
#   json.dump(list_url,l,ensure_ascii=False)

with codecs.open("/home/amel/enanyang/check_first_url_economic.json", 'w',encoding="utf_8_sig") as l:
