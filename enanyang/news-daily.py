...
data=0
url = "https://www.enanyang.my/api/get/term/articles/12?page=" ##news=11
page1 = str(url)+str(1)
...
# 	# print(link)
	...
	#---------save index html------------#
	filename_index = "/home/amel/enanyang/json/index/{}/news/index_{}.json".format(date,hash(link))
	...
	for j in jsonStr :
		try :
			...
			##-------save detail html-------##
			filename_content = "/home/amel/enanyang/html/content/{}/news/detail_{}.html".format(date,hash(detail_url))
			...
			##-----------save detail json-------------##
			filename_json = "/home/amel/enanyang/json/content/{}/news/detail_{}.json".format(date,hash(detail_url))
...
# with codecs.open("/home/amel/enanyang/check_url_news_daily.json", 'w',encoding="utf_8_sig") as l:
# 	json.dump(list_url,l,ensure_ascii=False)

with codecs.open("/home/amel/enanyang/check_first_url_news.json", 'w',encoding="utf_8_sig") as l:
