...
with open("/home/amel/chinadaily/check_first_url_currentaffairs.json", 'r', encoding='utf_8_sig') as outfile:
  first_url= json.load(outfile)
list_url = []

data=0

url = "http://china.chinadaily.com.cn/5bd5639ca3101a87ca8ff636/page_" #current-affairs
page = 0
max_page = 10
# print(proxy_)
...
while page <= max_page :
	...
	# 	print("page : "+str(page))
			...
			# #---------save index html------------#
		filename_index = "/home/amel/chinadaily/daily/html/index/{}/{}/current-affairs/index_{}.html".format(today,hours,hash(link))
	...
	#------looping title in index html to get detail html-------#
		...
		while link_index_array < title_link_count :
			...
			if detail_link in first_url :
				message = "Engine : Chinadaily  \n" + "Category : china-daily-current-affairs-hourly \n" +  "Data : " + str(data)
	...
	# 			# print("Date : " + detail_date)
				...
				if detail_article == 0 :
					detail_article = sp_detail.select('#Content>section>p')
				article = ""
	...
	# 			# print("Article : "+ str(detail_article))
		...
		# # 	#---------save detail html------------#
				...
				filename_content = "/home/amel/chinadaily/daily/html/content/{}/{}/current-affairs/detail_{}.html".format(today,hours,hash(detail_url))
	...
	# # #-----------save detail json-------------#
				...
				filename_json = "/home/amel/chinadaily/daily/json/content/{}/{}/current-affairs/detail_{}.json".format(today,hours,hash(detail_url))
				...
				except_json = {'link':detail_link,'date':today,'category':'current-affairs'}
				filename_except = "/home/amel/chinadaily/daily/except/content/{}/current-affairs/detail_except.json".format(today)
...
message = "Engine : Chinadaily  \n" + "Category : current-affairs-hourly \n" +  "Data : " + str(data)
telegram_bot_sendtext(str(message))

with codecs.open("/home/amel/chinadaily/check_first_url_currentaffairs.json", 'w',encoding="utf_8_sig") as l:
