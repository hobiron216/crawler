...
with open("/home/amel/chinadaily/check_first_url_whatabout.json", 'r', encoding='utf_8_sig') as outfile:
  first_url= json.load(outfile)
list_url = []

data=0

url = "https://cn.chinadaily.com.cn/gtx/5d63917ba31099ab995dbb29/Teahouse/page_" #what-about-china
page = 0
max_page = 10
# print(proxy_)
...
while page <= max_page :
	...
	# 	print("page : "+str(page))
			...
			# #---------save index html------------#
		filename_index = "/home/amel/chinadaily/daily/html/index/{}/{}/what-about-china/index_{}.html".format(today,hours,hash(link))
	...
	#------looping title in index html to get detail html-------#
		...
		while link_index_array < title_link_count :
			...
			if detail_link in first_url :
				message = "Engine : Chinadaily  \n" + "Category : china-daily-whatabout-hourly \n" +  "Data : " + str(data)
	...
	# 			# print("Article : "+ str(detail_article))
		...
		# # 	#---------save detail html------------#
				...
				filename_content = "/home/amel/chinadaily/daily/html/content/{}/{}/what-about-china/detail_{}.html".format(today,hours,hash(detail_url))
	...
	# # #-----------save detail json-------------#
				...
				filename_json = "/home/amel/chinadaily/daily/json/content/{}/{}/what-about-china/detail_{}.json".format(today,hours,hash(detail_url))
				...
				except_json = {'link':detail_link,'date':today,'category':'what-about-china'}
				filename_except = "/home/amel/chinadaily/daily/except/content/{}/what-about-china/detail_except.json".format(today)
...
message = "Engine : Chinadaily  \n" + "Category : what-about-china-hourly \n" +  "Data : " + str(data)
telegram_bot_sendtext(str(message))

with codecs.open("/home/amel/chinadaily/check_first_url_whatabout.json", 'w',encoding="utf_8_sig") as l:
