...
while page <= max_page :
	...
	# 	print("page : "+str(page))
			...
			# #---------save index html------------#
		filename_index = "/home/amel/chinadaily/daily/html/index/{}/china-daily-online-review/index_{}.html".format(today,hash(link))
	...
	#------looping title in index html to get detail html-------#
		...
		# 			# print("Article : "+ str(detail_article))
			...
			# # 	#---------save detail html------------#
					...
					filename_content = "/home/amel/chinadaily/daily/html/content/{}/china-daily-online-review/detail_{}.html".format(today,hash(detail_url))
		...
		# # #-----------save detail json-------------#
					...
					filename_json = "/home/amel/chinadaily/daily/json/content/{}/china-daily-online-review/detail_{}.json".format(today,hash(detail_url))
...
print("End")
print(list_url[0])
message = "Engine : Chinadaily  \n" + "Category : china-daily-online-review \n" +  "Data : " + str(data)
