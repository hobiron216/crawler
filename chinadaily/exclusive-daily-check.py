...
with open("/home/amel/chinadaily/check_first_url_exclusive.json", 'r', encoding='utf_8_sig') as outfile:
...
while page <= max_page :
	...
	# 	print("page : "+str(page))
			...
			# #---------save index html------------#
		filename_index = "/home/amel/chinadaily/daily/html/index/{}/{}/exclusive/index_{}.html".format(today,hours,hash(link))
	...
	#------looping title in index html to get detail html-------#
		...
		while link_index_array < title_link_count :
			...
			if detail_link in first_url :
				message = "Engine : Chinadaily  \n" + "Category : china-daily-exclusive-hourly \n" +  "Data : " + str(data)
	...
	# 			# print("Article : "+ str(detail_article))
		...
		# # 	#---------save detail html------------#
				...
				filename_content = "/home/amel/chinadaily/daily/html/content/{}/{}/exclusive/detail_{}.html".format(today,hours,hash(detail_url))
	...
	# # #-----------save detail json-------------#
				...
				filename_json = "/home/amel/chinadaily/daily/json/content/{}/{}/exclusive/detail_{}.json".format(today,hours,hash(detail_url))
