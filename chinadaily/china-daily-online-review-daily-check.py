...
with open("/home/amel/chinadaily/check_first_url_onlinereview.json", 'r', encoding='utf_8_sig') as outfile:
  first_url= json.load(outfile)
list_url = []
url = "https://cn.chinadaily.com.cn/gtx/5d63917ba31099ab995dbb29/wangping/page_" #china-daily-online-review
# url = "https://cn.chinadaily.com.cn/gtx/5d63917ba31099ab995dbb29/shijieguan/page_" #worldview
...
while page <= max_page :
	...
	# 	print("page : "+str(page))
			...
			# #---------save index html------------#
		filename_index = "/home/amel/chinadaily/daily/html/index/{}/{}/china-daily-online-review/index_{}.html".format(today,hours,hash(link))
		...
		title_link = []
		for index in soup.select('.busBox1-two>div>div>h3>a'):
			link = index.get('href')
			# print(link)
	...
	#------looping title in index html to get detail html-------#
		...
		while link_index_array < title_link_count :
			...
			if detail_link in first_url :
				message = "Engine : Chinadaily  \n" + "Category : china-daily-online-review-hourly \n" +  "Data : " + str(data)
	...
	# 			# print("Date : " + detail_date)
				...
				if len(detail_article)== 0 :
					detail_article = sp_detail.select('.article>p')
				article = ""
	...
	# 			# print("Article : "+ str(detail_article))
		...
		# # 	#---------save detail html------------#
				...
				filename_content = "/home/amel/chinadaily/daily/html/content/{}/{}/china-daily-online-review/detail_{}.html".format(today,hours,hash(detail_url))
	...
	# # #-----------save detail json-------------#
				...
				filename_json = "/home/amel/chinadaily/daily/json/content/{}/{}/china-daily-online-review/detail_{}.json".format(today,hours,hash(detail_url))
				...
				except_json = {'link':detail_link,'date':today,'category':'china-daily-online-review'}
				filename_except = "/home/amel/chinadaily/daily/except/content/{}/china-daily-online-review/detail_except.json".format(today)
...
with codecs.open("/home/amel/chinadaily/check_first_url_onlinereview.json", 'w',encoding="utf_8_sig") as l:
